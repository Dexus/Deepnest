  ...
  hooks: {
    packageAfterPrune: async (
      ...
      console.log(
        ...
        execSync(`npm install --cpu ${arch} --os ${myPlatform} --arch=${arch} --platform=${myPlatform}`, { cwd: buildPath, stdio: 'inherit', env: { ...process.env,npm_config_platform:myPlatform, npm_config_arch:arch } });
      } catch (error) {
